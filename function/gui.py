    ...
    def __init__(self,state, data=None, header=None):
        if state.popup_login: #ログイン画面
            ...
            layout = [[sg.T("科目修正・削除")],
                      ...
                      [sg.Checkbox("合否科目",default=False, key="-Pass/Fail-"), sg.Checkbox("教職科目",default=False, key="-Teacher-")],
            ...
            layout = [[sg.T("　　　　  累積GPA："),sg.T("0.00", key="-GPA-")],
                      [sg.T("　　　 卒業単位数："),sg.T("0単位", key="-Graduation_total_units_num-")],
                      [sg.T("　　　 累積単位数："),sg.T("0単位", key="-all_total_units_num-")],
