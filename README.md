...
### 成績情報の修正・削除
成績情報を間違えて入力した場合や、成績情報を削除したい場合は下部ボタン**成績情報修正・削除**を押下することにより、成績情報を修正・削除することができる。
※成績情報を修正する場合は、**修正したい科目名**を入力し、**修正したい項目**を入力することにより、成績情報を修正することができる。
※成績情報を削除する場合は、**削除したい科目名**を入力することにより、成績情報を削除することができる。
### 成績情報のリセット
